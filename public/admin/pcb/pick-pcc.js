        ...
        render:function(){
            ...
            if(format && format!=""){
                ...
                contentStr = '<div class="pick-show">'+
                    ...
                    '<span class="pick-county">请选择站点</span>'+
        ...
        createCounty:function(e){
            ...
            if(setCity=="请选择市"){
                ...
                for(var t=0;t<countyJson.length;t++){
                    if(t==0){
                        countyStr = '<li class="ulli" data-code="">请选择站点</li>'
                    }
        ...
        setVal:function(_thisP,aim,s){
            ...
            if(s=="pro"){
                ...
                if($(aim).html()=="请选择省"){
                    ...
                    this.ele.find(".pick-county").html("请选择站点");
                ...
                if($(aim).html()=="请选择站点"){
                    ...
                    if(this.ele.find(".pick-county").html()=="请选择站点"){
                        //alert(1)
                    } else {
                        //alert(2)
                        this.ele.find(".pressActive").html($(aim).html());
