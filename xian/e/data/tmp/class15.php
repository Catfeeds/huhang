...
<body ontouchstart>
    ...
    <section class="banner design-banner">
        <img src="/mobile/static/images/ban04.png">
    </section>
    <!-- banner区 end -->
    <!-- 限时免费设计 begin -->
    <section class="vr-show design-show">
        <form id="activity-form1" class="form-center all-form" name='feedback' method='post' enctype='multipart/form-data' action='/e/enews/index.php'>
            <input type=hidden name=ecmsfrom value="/mobile/activity/index.html"> 
            <input name='enews' type='hidden' value='AddFeedback'>
            <input name='title' type='hidden' value='最新优惠头部表单'> 
            ...
            <input type="submit" value="立即抢优惠活动" class="sub-btn">
        </form>
    </section>
    <!-- 限时免费设计 end -->
    ...
    <section class="reservations">
        ...
        <div class="swiper-container swiper-no-swiping" id="reser-cg">
    ...
    <div class="p-ssl">
			<h4>
				<i><img src="/mobile/static/images/32.png" /></i>随手礼
			</h4>
			<div class="p-s-con">
				<img src="/mobile/static/images/ssl.png" class="p-i-img"  />
				<p>
					<img src="/mobile/static/images/33.png" />
				</p>
			</div>
		</div>
    ...
    <div class="p-ssl">
		<h4>
			<i><img src="/mobile/static/images/32.png" /></i>进门礼包
		</h4>
		<div class="p-s-con">
			<img src="/mobile/static/images/kmhb.png" class="p-i-img"  />
			<p>
				<img src="/mobile/static/images/33.png" />
			</p>
		</div>
	...
	<div class="p-ssl">
		<h4>
			<i><img src="/mobile/static/images/32.png" /></i>家具礼包
		</h4>
		<div class="p-s-con">
			<img src="/mobile/static/images/jjlb.png" class="p-i-img"  />
	...
	<div class="p-ssl">
		<h4>
			<i><img src="/mobile/static/images/32.png" /></i>家电礼包
		</h4>
		<div class="p-s-con">
			<img src="/mobile/static/images/jdlb.png" class="p-i-img"  />
	...
	<div class="p-ssl">
		<h4>
			<i><img src="/mobile/static/images/32.png" /></i>超值大礼包
		</h4>
		<div class="p-s-con">
			<img src="/mobile/static/images/czlb.png" class="p-i-img"  />
    ...
    <section class="acti-b">
        <p>
            <i></i>凡在《铁锤工艺》活动期间签单的业主，可享受 三大承诺五大保障
        </p>
        <p>
            <i></i>以上《铁锤工艺》活动全程由陕西FM89.6汽车调频监督
        </p>
    </section>
    ...
    <section class="global zero-price ">
        ...
        <form id="activity-form2" class="form-center all-form" id="zero-price-form" name='feedback' method='post' enctype='multipart/form-data' action='/e/enews/index.php'>
            <input type=hidden name=ecmsfrom value="/mobile/activity/index.html"> 
            <input name='enews' type='hidden' value='AddFeedback'>
            <input name='title' type='hidden' value='最新优惠底部表单'> 
            <input type=hidden name=bid value=1> 
            <input type=hidden name=laiyuan id=laiyuan>                   
            <input type=hidden name=chuangyi id=chuangyi>
            <!-- 有效表单 begin -->
        ...
        <ul class="ticket">
            ...
            <div class="quan-form sj-quan">
                <form id="activity-q1" class="form-center" name='feedback' method='post' enctype='multipart/form-data' action='/e/enews/index.php'>
            ...
            <div class="quan-form lf-quan">
                <form id="activity-q2" class="form-center" name='feedback' method='post' enctype='multipart/form-data' action='/e/enews/index.php'>
