...
<td height="60">
  ...
  <form name="menuform" id="menuform">
	...
	<input type="hidden" name="onclickmenu" value="">
      <TR> 
            <TD width="180"><div align="center"><a href="main.php<?=$ecms_hashur['whehref']?>" target="main" title="千百炼网站管理系统"><img src="adminstyle/1/images/logo.gif" border="0"></a></div></TD>
		<TD height="60"> 
...
<div align="center"><font color="#FFFFFF"><strong>插件</strong></font></div></td>
					...
					<TD width=60 onmouseout="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='';}" onmouseover="if(document.menuform.onclickmenu.value!='doshopmenu'){this.style.backgroundColor='#8CBDEF';}" onclick="DoOnclickMenu('doshopmenu'); style="CURSOR: hand;<?=$showshopmenu?'':'display:none'?>" id="doshopmenu"> 
                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                        <tr> 
              ...
              <TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle> 
					...
					{
					?>
                    <TD width="60" class="flyoutLink" onclick="JumpToMain('千百炼/AdminPage.php?leftfile=<?=urlencode('../pl/PlNav.php'.$ecms_hashur['whehref'])?>&mainfile=<?=urlencode('../pl/PlMain.php'.$ecms_hashur['whehref'])?>&title=<?=urlencode('管理评论')?><?=$ecms_hashur['ehref']?>');" onmouseover="over(this)" onmouseout="out(this)">管理评论</TD>
					<?php
					}
					?>
					...
					<TD width="60" class="flyoutLink" onclick="JumpToMain('/e/admin/admin.php?ehash_Xgm5S=bibaWmJOGX5YAhg9dfqJ');" onmouseover="over(this)" onmouseout="out(this)"><b>查看预约</b></TD>
                  </TR>
                </TBODY>
              </TABLE>            </TD>
