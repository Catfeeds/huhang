...
$ecms_config['db']['dbusername']='xian';	//数据库用户名
$ecms_config['db']['dbpassword']='v2r#Gu%E';	//数据库密码
$ecms_config['db']['dbname']='xian';	//数据库名
...
//后台安全设置
$ecms_config['esafe']['loginauth']='qblzs888';	//登录认证码,如果设置登录需要输入此认证码才能通过
$ecms_config['esafe']['enloginauth']=0;	//登录认证码加密验证串有效时间,单位:秒(0为不启用加密)
$ecms_config['esafe']['ecookiernd']='vlkjZfmj7vJeOzH4cGihqW7DQw9IinXGxNVC';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='hwurt';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='hzsmu';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='MV88ka5IEvYH0IY6LPOucaUBzfVj36JyQ6g';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='pV4GVW2Y0ErTX600O6XPfkpAz74Kks7nXM';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='ktDbGxompcGks3cfdqerKa7ZEL6qTFp5J';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='eMkdiKCPWe3385KU11rKs7YEfGhkEv9L';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='zzkZJGLj9ua39YuZ3eTpRD2jiYsdmKP';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>2,
'keytime'=>900,
'keyrnd'=>'SoUMamuyiun1h872BmYNT9dWGj5nv90t',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/product/\">定制整装</a>&nbsp;|&nbsp;<a href=\"/design/\">量房设计</a>&nbsp;|&nbsp;<a href=\"/quote/\">智能报价</a>&nbsp;|&nbsp;<a href=\"/case/\">实景样板间</a>&nbsp;|&nbsp;<a href=\"/process/\">德系工艺</a>&nbsp;|&nbsp;<a href=\"/about/\">关于我们</a>&nbsp;|&nbsp;<a href=\"/mobile/\">手机站首页</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'openfileserver'=>0,
'fs_purl'=>'',
'closemods'=>',down,movie,shop,pay,rss,fieldand,',
'fieldandtop'=>0,
'fieldandclosetb'=>'',
'filedatatbs'=>',1,',
'filedeftb'=>1,
...
'bakescapetype'=>1,
'hkeytime'=>30,
'hkeyrnd'=>'YvhZrBVDG8MrJL21rfyvoRyEfvJJqxsPWAiI',
'mhavedatedo'=>0,
'reportkey'=>0,
'ctimeopen'=>0,
'ctimelast'=>0,
...
'ctimegids'=>'',
'ctimecids'=>'',
'ctimernd'=>'bEsG9JJlpiSaPffZA7t22yGJrat5IRBaWFYbUsdNoD',
'qmadminuids'=>'',
'qmforumuids'=>'',
'qmotheruids'=>'',
'ckhavemoreport'=>0,
